...
case 'confirmar_pago':
    include_once "controllers/pasarela/confirmar_pago.control.php";
    die();

case 'respuesta':
    include_once "controllers/pasarela/respuesta.control.php";
    die();
...
if(mw_estaLogueado()){
        ...
        include_once "controllers/retail/historiaCompra.control.php";
    }
    die();
...
case "cartauthClient":
    ($logged) ?
      include_once "controllers/retail/cartAuthClient.control.php" :
      mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();

case 'confir_pago_cli':
    ($logged) ?
    include_once "controllers/pasarela/confirmar_pago_auth.control.php":
    mw_redirectToLogin($_SERVER["QUERY_STRING"]);
    die();
